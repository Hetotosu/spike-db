    ...
    soccer: {
        ...
        Adidas: {
            "PREDATOR": [
                ...
                {
                    id: "pred_pro", name: "プレデター プロ", price: 19800, img: "predator_pro.jpg",
                    colors: [{img: "predator_pro.jpg", color: "#000"}],
                    eval: [3, 4, 4, 4, 3],
                ...
                {
                    id: "pred_league", name: "プレデター リーグ", price: 9900, img: "predator_league.jpg",
                    colors: [{img: "predator_league.jpg", color: "#000"}],
                    eval: [2, 3, 3, 5, 5],
            ...
            "コパアイコン2": [
                ...
                {
                    id: "copa_league", name: "コパアイコン2 リーグ", price: 8800, img: "copaicon_league.jpg",
                    colors: [{img: "copaicon_league.jpg", color: "#d4af37"}],
                    eval: [2, 2, 3, 5, 5],
        ...
        Puma: {
            "FUTURE": [
                {
                    id: "future_ultimate", name: "フューチャー アルティメット", price: 26400, img: "future_ultimate.jpg",
                    colors: [{img: "future_ultimate.jpg", color: "#0af"}],
                    eval: [3, 4, 4, 3, 3],
                ...
                {
                    id: "future_pro", name: "フューチャー プロ", price: 15400, img: "future_pro.jpg",
                    colors: [{img: "future_pro.jpg", color: "#0af"}],
                    eval: [3, 3, 4, 3, 4],
                ...
                {
                    id: "future_match", name: "フューチャー マッチ", price: 9900, img: "future_match.jpg",
                    colors: [{img: "future_match.jpg", color: "#0af"}],
                    eval: [2, 3, 3, 4, 5],
            ...
            "ULTRA": [
                {
                    id: "ultra_ultimate", name: "ウルトラ アルティメット", price: 24200, img: "ultra_ultimate.jpg",
                    colors: [{img: "ultra_ultimate.jpg", color: "#ff0"}],
                    eval: [5, 2, 3, 3, 3],
                ...
                {
                    id: "ultra_pro", name: "ウルトラ プロ", price: 14300, img: "ultra_pro.jpg",
                    colors: [{img: "ultra_pro.jpg", color: "#ff0"}],
                    eval: [4, 2, 2, 3, 4],
                ...
                {
                    id: "ultra_match", name: "ウルトラ マッチ", price: 8800, img: "ultra_match.jpg",
                    colors: [{img: "ultra_match.jpg", color: "#ff0"}],
                    eval: [3, 2, 2, 5, 5],
            ...
            "KING": [
                {
                    id: "king_ult", name: "キング アルティメット", price: 26400, img: "king_ultimate.jpg",
                    colors: [{img: "king_ultimate.jpg", color: "#000"}],
                    eval: [3, 3, 5, 4, 3],
